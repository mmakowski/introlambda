...
\infer{\phi\Rightarrow\psi}{\infer*{\psi}{\phi}} \> (implication introduction)
}
\end{frame}
% -------------------------------------------
\begin{frame}{Curry-Howard Correspondence}
...
\infer{\phi\Rightarrow\psi}{\infer*{\psi}{\phi}} \> \infer{\lambda x.M:\sigma\rightarrow\tau}{\infer*{M:\tau}{x:\sigma}}
}
\end{frame}
