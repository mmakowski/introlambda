...
\hr
TODO: nicer redexes
$$(\lambda a.(\lambda b.b) [1]a) [3] ((\lambda c.\lambda d.d)[2] \lambda f.f)$$
\end{center}
\end{frame}
% -------------------------------------------
...
\infer{\phi\Rightarrow\psi}{\infer*{\psi}{\cancel{\phi}}} \> (implication introduction)
}
\end{frame}
% -------------------------------------------
\begin{frame}{Curry-Howard Correspondence}
\centeredtab{
\infer{\psi}{\phi\Rightarrow\psi & & \phi}~~~~~~~~~~~     \= \infer{M\,N:\tau}{M:\sigma\rightarrow\tau & & N:\sigma} \\\\\\ 
\infer{\phi\Rightarrow\psi}{\infer*{\psi}{\cancel{\phi}}} \> \infer{\lambda x.M:\sigma\rightarrow\tau}{\infer*{M:\tau}{\cancel{x:\sigma}}}
}
\end{frame}
...
\path[mindmap, 
    ...
    child[concept color=lightgray!50!white,text=gray] { node[concept] {Y} }
    child[concept color=orange] { node[concept] {SKI} };
\end{tikzpicture}
\end{center}
\end{frame}
% -------------------------------------------
...
\msym{I} &= \msym{S}\,\msym{K}\,\msym{K}
\end{align*}
\hr
\begin{align*}
\phantom{\lambda x.\lambda y.yx = \msym{S}\,(\msym{K}\,(\msym{S}\,\msym{I}))\,(\msym{
...
\hr
\begin{align*}
\lambda x.\lambda y.yx &= \msym{S}\,(\msym{K}\,(\msym{S}\,\msym{I}))\,(\msym{
                          S}\,(\msym{K}\,\msym{K})\,\msym{I}) 
\end{align*}
\end{frame}
% -------------------------------------------
